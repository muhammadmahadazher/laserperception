...
Raw intensity mismatch is not supported as a sufficient explanation for either observation, but
intensity causality or a unique mechanism is not established. Primary and zero-intensity processes
